                ...
                <div class="row">
                    <div class="col-md-12">
                        <form style="border: 2px solid lightgrey;
                              ...
                              background-size: 200% auto; text-align: left" method="POST" action="addcoupon">
                            <div class="row">
                                <div class="col">
                                    <label for="code">Coupon code</label>
                                    <input type="text" class="form-control input-lg" id="code" name="code" required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                                    ...
                                    <select name="type" class="form-control">
                                        ...
                                        <option value="1">Minus the Total</option>
                                    </select>
                                </div>
                                <div class="col">
                                    <label for="discount">Discount</label>
                                    <input type="text" class="form-control input-lg" id="discount" name="discount" required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                                    <label for="from">From</label>
                                    <input class="form-control input-lg" type="date" id="from" name="from" required>
                                </div>
                                <div class="col">
                                    <label for="to">To</label>
                                    <input class="form-control input-lg" type="date" id="to" name="to" required>
                                </div>
                            </div>
