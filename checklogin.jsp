<%-- 
    ...
    Created on : Mar 24, 2020, 4:55:10 PM
    Author     : Admin
--%>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="breadcrumb_iner">
                            <h2 class="text-center text1">You need to login to perform this action.</h2>  
                            <h4 class="text-center text2">You have already had an account. 
                                <a href="http://localhost:8080/BakeryAndCafe/login.jsp"> Login</a></h4>
                            <h4 class="text-center text2">You do not have an account. 
                                <a href="http://localhost:8080/BakeryAndCafe/signup.jsp"> Sign Up</a></h4>
                        </div>
                    </div>
                </div>
            </div>
