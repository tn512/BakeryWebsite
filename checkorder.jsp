                ...
                <div class="row">
                    <div class="col-md-12">
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <c:forEach items="${sessionScope.vieworders}" var="o">
                                    <tr>
                                        ...
                                        <td>${o.createddate}</td>
                                        <td>${o.total}</td>
                                        <td><a href="deleteorder?id=${o.order_id}"> Delete</a></td>
                                        <td><a href="orderdetail?id=${o.order_id}"> View</a></td>
                                    </tr>
                    ...
                    <div class="paging">
                        <c:forEach begin="1" end="${requestScope.maxPage}" var="i" >
                            <a class="${i==requestScope.pageIndex?"active":""}" href="checkorder?pageIndex=${i}">${i}</a>
                        </c:forEach>
                    </div>
                </div>
            </div>
