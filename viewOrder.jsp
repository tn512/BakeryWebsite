    ...
    <body>
        ...
        <section class="product_list section_padding">
            <div class="container">
                <div class="row">
                    <div class="col-md-2">
                        <a class="btn btn-success theme" href="http://localhost:8080/BakeryAndCafe/info">Info</a>
                    ...
                    <div class="paging">
                        <c:forEach begin="1" end="${requestScope.maxPage}" var="i" >
                            <a class="${i==requestScope.pageIndex?"active":""}" href="vieworder?pageIndex=${i}">${i}</a>
                        </c:forEach>
                    </div>
                </div>
            </div>
